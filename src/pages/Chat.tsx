...
export default function Chat() {
  ...
  return (
    <div className="absolute inset-0 flex overflow-hidden bg-gray-50 dark:bg-gray-900">
      <AnimatePresence initial={false} mode="wait" custom={selectedCoach ? 1 : -1}>
        {!selectedCoach ? (
          <motion.div
            key="list"
